...
L'orientamento ad una struttura di questo tipo permette di ottenere due vantaggi importanti:

\begin{itemize}
	\item \textbf{Diminuire la complessità del sistema:}
	una divisione in progetti separati permette innanzitutto una complessità generale minore e una divisione delle responsabilità ben definita.
	Una suddivisione esplicita consentirà, dal punto di vista aziendale, una più chiara divisione dello sviluppo; utile soprattutto qualora il progetto dovesse essere affidato a più sviluppatori.
	
	\item \textbf{Consente un multi-platform parziale:}
	se da una parte, il servizio di filtraggio dovrà necessariamente comunicare con l'\gls{OS}, 
\end{itemize} 
