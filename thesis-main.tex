...
In sintesi, il nuovo design del servizio Windows prevede l'implementazione di un server named pipe che, su comando dell'utente, interagisce con il servizio di protezione per avviare o interrompere l'esecuzione di un server \gls{DNS} locale, impostato come predefinito di sistema.
