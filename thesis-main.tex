...
Pertanto, a svolgere tale ruolo è \class{PipeClient}, che si occupa di inviare e ricevere dati dal servizio Windows, ottenendo risposte sull'esito delle operazioni e sullo stato della protezione.
...
Tali eventi, che rappresentano tipicamente il passaggio da uno stato all'altro,  necessitano una visione globale sull'applicazione ed una gestione centralizzata, compito che non può essere svolto da un semplice \class{Presenter}.
