...
La routine di ascolto delle richieste è completamente affidata a \class{UdpListener}, un'implementazione dell'interfaccia \class{SocketListener} che utilizza il client UDP delle librerie di sistema per monitorare la porta 53, dedicata alle comunicazioni \gls{DNS}.
...
Sebbene si sia discusso del possibile sviluppo di un'interfaccia grafica multi-piat-taforma, il prototipo di ClientShield utilizza la libreria \gls{WPF}, specifica per ambienti Windows.
