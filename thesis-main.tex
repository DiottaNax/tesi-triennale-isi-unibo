...
Ciò consente di di estendere i metodi per avviare e interrompere il server, facendo in modo di modificare automaticamente il \gls{DNS} predefinito del dispositivo.
Il pattern risulta davvero utile, in quanto consente di isolare l'utilizzo di librerie specifiche per Windows a due sole classi, aprendo la possibilità ad un futuro sviluppo multi-platform.
