...
La struttura delle classi viene illustrata in figura \ref{fig:protezione-facade-pattern}.
Il server named pipe si occupa esclusivamente di ricevere ed elaborare le richieste da parte del client, delegando l'esecuzione di qualsiasi operazione alla classe ProtectionManager.
...
\end{figure}
ProtectionManager coordina l'esecuzione delle funzionalità offerte dalle classi gestite, consentendo una gestione implicita delle credenziali affidata completamente al CredentialManager.
