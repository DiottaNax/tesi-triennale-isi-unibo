...
Tale protocollo, infatti, si presta meglio ad un'azienda che offre filtraggio \ac{DNS} rispetto ad una classica \ac{VPN}. \ac{DoH} garantisce la riservatezza sfruttando il protocollo sicuro \ac{HTTPS} 
