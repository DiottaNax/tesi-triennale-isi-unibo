...
Tale fase permette di comprendere il contesto in cui il software opera, chi sono gli attori principali e quali sono i loro scopi.
In questo progetto l'analisi del dominio è risultata molto rapida e semplice, in quanto il prodotto è stato accordato con un'azienda interna al settore informatico.
...
\begin{itemize}
	\item \textbf{Utente finale}: cioè l'utilizzatore del dispositivo da proteggere, il quale navigherà normalmente il web, inviando naturalmente richieste \gls{DNS}
\end{itemize}
